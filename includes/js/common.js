...
$(".system-tabs .tabs-links:not(.links) a").click(function (e) {
  ...
  if (!li.hasClass("active")) {
    ...
    var left =
      parent[0].scrollLeft + $(this).offset().left - parent.offset().left;
    var top = $(this).offset().top - parent.offset().top + 22;
    $(".design-element", parent).css({
      width: width + "px",
      left: left + "px",
      top: top + "px",
    });
...
$(".header-login .wrap-login > .close, .header-login .login-bg").click(
  function (e) {
...
if ($(".main-slider").length > 0) {
  ...
  $(".main-slider").on("beforeChange", function (e, s, d, n) {
    ...
    $(".wrap-main-slider .bgs div:nth-child(" + (n + 1) + ")").addClass(
      "active"
    );
...
$.each($(".input-date"), function () {
  $(this).datepicker({
    onClose: function () {
      ...
      setTimeout(function () {
        $("#ui-datepicker-div").removeClass("pos");
      }, 1);
    },
    beforeShow: function () {
      ...
      setTimeout(function () {
        $("#ui-datepicker-div").addClass("pos");
      }, 1);
    },
  });
...
$("form").submit(function (e) {
  ...
  $.each($("input[data-req], textarea[data-req]", $(this)), function () {
    if (
      ($(this).attr("type") == "tel" &&
        ($(this).val().split("")[15] == undefined ||
          $(this).val().split("")[15] == "_")) ||
      ($(this).attr("type") == "email" && !emainPattern.test($(this).val())) ||
...
if (typeof ymaps != "undefined" && ymaps != null) {
  ...
  function init() {
    ...
    var MyBalloonLayout = ymaps.templateLayoutFactory.createClass(
      '<div class="map-ballon">' + "$[[options.contentLayout]]" + "</div>",
      {
        build: function () {
